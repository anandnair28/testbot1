...
QUIZ_COMPLETED_TOAST = "You have already completed the hunt! Now go follow festember_inductions Instagram handle to learn more"
...
class Database:
    ...
    def get_hint(self, username):
        ...
        #     # . so compare with the last_hint_used_time
